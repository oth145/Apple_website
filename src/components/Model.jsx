...
function Model() {
  ...
  // camerea control for the model view;
...
const tl = gsap.timeline();
  useEffect(() => {
    ...
    if(size === "small") {
      animateWithGsapTimeLine(tl, large , largRotation , '#view2','#view1', {
    ...
    <section className='common-padding'>
      <div className='screen-max-width'>
        ...
        <div className='flex flex-col items-center mt-5'>
          ...
          <ModelView
          index={1} groupRef={small} gsapType="view1" controlRef={cameraControlSmall} setRotationState={setSmallRotation} item={model}
          size={size}
          />
          <ModelView
          index={2} groupRef={large} gsapType="view2" controlRef={cameraControlLarge} setRotationState={setLargRotation} item={model}
          size={size}
          />
          <Canvas
